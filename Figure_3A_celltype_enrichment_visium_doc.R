...
# ---------------------------------------------------------------------------
# Sample Name Mapping (Raw → Formatted Names in Seurat)
# ---------------------------------------------------------------------------
...
for (i in 1:nrow(celltrek_no_interpolation_celltypes_inp)) {
  ...
  # Generate spot → cell type counts for the sample
